...
def add_doctor():
    if request.method == 'POST':
        ...
        return render_template('admin_templates/doctor/add_doctor_templates.html', departments=departments)
...
def view_all_doctors():
    try:
        ...
        return render_template("admin_templates/doctor/view_doctor_templates.html", doctors=doctors)
